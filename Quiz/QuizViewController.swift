...
class QuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //------------------------ここから下にクイズを書く------------------------//
        quizArray.append(["徳川家康の家臣の徳川四天王のうち間違えている武将は誰か？", "本田忠勝", "井伊直政", "服部半蔵", 3])
        quizArray.append(["真田幸村が大阪城に築いた真田丸は東西南北のどこに作られたでしょうか？", "北", "東", "南", 3])
        quizArray.append(["真田幸村が大阪城に築いた真田丸は東西南北のどこに作られたでしょうか？", "北", "東", "南", 3])        //------------------------ここから上にクイズを書く------------------------//
